...
.controller("WebDevController",function($scope){
	/*$(function(){
		$("a[href$='#/webdev']").click(function(){
			$("#webdevBox .leftSmall, #webdevBox .rightLarge").hide(1);
			setTimeout(function(){
				$("#webdevBox .leftSmall, #webdevBox .rightLarge").show(1000);	
			},1) 
		});
	});*/
	$(function(){
		$("a[href$='#/webdev']").click(function(){
			$("#webdevBox .leftSmall").animate({right:"500"},1);
			setTimeout(function(){
				$("#webdevBox .leftSmall").animate({right:"0"},1000);	
			},1000) 
		});
	});
})
